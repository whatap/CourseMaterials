...
public class InventoryServiceApplication {
  ...
  public void initIndicesAfterStartup() {
    ...
    ReactiveIndexOperations indexOps = mongoTemplate.indexOps(InventoryEntity.class);
    resolver.resolveIndexFor(InventoryEntity.class).forEach(e -> indexOps.ensureIndex(e).block());
  }
}
